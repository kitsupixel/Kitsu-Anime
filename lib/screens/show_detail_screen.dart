...
class ShowEpisodeListWidget extends StatefulWidget {
  ShowEpisodeListWidget({Key key, this.showId}) : super(key: key);

  final showId;

  @override
  _ShowEpisodeListWidget createState() => _ShowEpisodeListWidget();
}

class _ShowEpisodeListWidget extends State<ShowEpisodeListWidget> {
