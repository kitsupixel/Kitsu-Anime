...
/// [CustomFlexibleSpaceBar] when used in a [SliverAppBar]. This app bar is configured
/// to stretch into the overscroll space, and uses the
/// [CustomFlexibleSpaceBar.stretchModes] to apply `fadeTitle`, `blurBackground` and
...
class CustomFlexibleSpaceBar extends StatefulWidget {
  ...
  /// See also:
  ///
  ///  * [CustomFlexibleSpaceBarSettings] which creates a settings object that can be
  ...
  Widget build(BuildContext context) {
    return LayoutBuilder(
      builder: (BuildContext context, BoxConstraints constraints) {
        //final CustomFlexibleSpaceBarSettings settings = context.dependOnInheritedWidgetOfExactType<CustomFlexibleSpaceBarSettings>();
        final FlexibleSpaceBarSettings settings = context.dependOnInheritedWidgetOfExactType<FlexibleSpaceBarSettings>();
        assert(
          settings != null,
          'A CustomFlexibleSpaceBar must be wrapped in the widget returned by CustomFlexibleSpaceBar.createSettings().',
        );
